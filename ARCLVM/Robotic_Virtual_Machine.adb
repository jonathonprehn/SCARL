	...
	begin
		...
		if Debug_Output then
			declare
				use Ada.Text_IO;
			begin
				Put_Line("ADD" & Integer'Image(Integer(Register_State(Reg1.Register))) &
				" +" & Integer'Image(Integer(Register_State(Reg2.Register) - Register_State(Reg1.Register))) & 
				" =" & Integer'Image(Integer(Register_State(Reg2.Register))));
			end;
		end if;
	end Invoke_ARCL_ADD;
	...
	begin
		...
		if Debug_Output then
			declare
				use Ada.Text_IO;
			begin
				Put_Line("LOADF value" & Integer'Image(Integer(Register_State(Reg.Register)))
					& " from stack memory location" &
					Integer'Image(Integer(Frame_Pointer + Offset.Memory_Offset)));
			end;
		end if;
	...
	begin
		...
		if Debug_Output then
			declare
				use Ada.Text_IO;
			begin
				Put_Line("LOADR value" & Integer'Image(Integer(Register_State(Reg.Register)))
					& " from heap memory offset" &
					Integer'Image(Integer(Offset.Memory_Offset)));
			end;
		end if;
	...
	begin
		...
		if Debug_Output then
			declare
				use Ada.Text_IO;
			begin
				Put_Line("STORF value" & Integer'Image(Integer(Register_State(Reg.Register)))
					& " into stack memory offset" &
					Integer'Image(Integer(Frame_Pointer + Offset.Memory_Offset)));
			end;
		end if;
	...
	begin	
		...
		if Debug_Output then
			declare
				use Ada.Text_IO;
			begin
				Put_Line("STORR value" & Integer'Image(Integer(Register_State(Reg.Register)))
					& " into heap memory offset" &
					Integer'Image(Integer(Offset.Memory_Offset)));
			end;
		end if;
	...
	begin
		...
		if Debug_Output then
			declare	
				use Ada.Text_IO;
			begin
				Put_Line("Stack grew by offset" & 
					Integer'Image(Integer(Offset.Memory_Offset)) &
					". Frame pointer is now" & Integer'Image(Integer(Frame_Pointer)));
			end;
		end if;
	...
	begin
		...
		if Debug_Output then
			declare	
				use Ada.Text_IO;
			begin
				Put_Line("Stack shrunk by offset" & 
					Integer'Image(Integer(Offset.Memory_Offset)) &
					". Frame pointer is now" & Integer'Image(Integer(Frame_Pointer)));
			end;
		end if;
